    ...
    var methods = {
        ...
        getMe: function (_t) {
            if (!_hasLogin) {
		      ...
		      logout: function() {
            var logout_url = encodeURI("https://www.facebook.com/logout.php?next=" + config.host + "/connect/logout_success.html&access_token=" + facebook_token);
            var face = window.open(logout_url, '_blank', 'hidden=yes,location=no'),
                callback = function(location) {
                   if(location.url ===  config.host + "/connect/logout_success.html") {
                      face.close();
                   }
                };
